...
class __TwigTemplate_379d772d2749232a3fa44696be620e09 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
        <h5><a href=\"";
        // line 9
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("create_book");
        echo "\">- Create book</a></h5>
        <h5><a href=\"";
        // line 10
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("show_all_books");
        echo "\">- Show all books</a></h5>
    </div>
</div>
";
...
<div class=\"container\">
    <h1>Library</h1>
    <div>
        <h5><a href=\"{{ url(\"create_book\") }}\">- Create book</a></h5>
        <h5><a href=\"{{ url(\"show_all_books\") }}\">- Show all books</a></h5>
    </div>
</div>
{% endblock %}
", "book/index.html.twig", "/Users/agnes/dbwebb-kurser/mvc/me/report/templates/book/index.html.twig");
    }
}
