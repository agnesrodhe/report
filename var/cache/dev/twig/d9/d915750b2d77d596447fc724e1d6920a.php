...
class __TwigTemplate_4890d548b603efcc700263df7dae041e extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    <form action=\"";
        ...
        <fieldset class=\"form-group\">
            ...
            <input type=\"submit\"class=\"margin btn btn-success btn-lg btn-block\" value=\"Add\">
        </fieldset>
            </form>
        </div>        
    </form>
...
<div class=\"container\">
    <h1>Add book to Library</h1>
    <form action=\"{{ path(\"show\") }}\" method=\"post\">
        <fieldset class=\"form-group\">
            <div>
                <label class=\"margin\">Title</label>
                <input type=\"text\" class=\"form-control\" name=\"title\">
...
{% endblock %}
", "book/create.html.twig", "/Users/agnes/dbwebb-kurser/mvc/me/report/templates/book/create.html.twig");
    }
}
